...
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetfriendListsRequest::_internal_id() const {
  return id_;
}
inline ::PROTOBUF_NAMESPACE_ID::uint32 GetfriendListsRequest::id() const {
  // @@protoc_insertion_point(field_get:fixbug.GetfriendListsRequest.id)
  return _internal_id();
}
inline void GetfriendListsRequest::_internal_set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
  
  id_ = value;
}
inline void GetfriendListsRequest::set_id(::PROTOBUF_NAMESPACE_ID::uint32 value) {
